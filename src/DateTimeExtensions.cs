...
namespace Fuzzy
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="minimum"/> is greater than the current maximum of the fuzzy range, or <paramref name="minimum"/> plus <paramref name="timeSpan"/> is less than <paramref name="minimum"/>.</exception>
