...
namespace Fuzzy
{
    ...
    {
        /// <summary>Returns a fuzzy <see cref="System.Collections.Generic.List{T}"/> whose elements are produced by <paramref name="createElement"/>.</summary>
        ...
        /// <summary>Returns a fuzzy <see cref="System.Collections.Generic.List{T}"/> whose elements are chosen from <paramref name="elements"/>.</summary>
