...
namespace Fuzzy
{
    public static class IFuzzListExtensions
    {
        ...
        public static Fuzzy<List<T>> List<T>(this IFuzz fuzzy, Func<Fuzzy<T>> createElement, Count count = default) =>
        ...
        public static Fuzzy<List<T>> List<T>(this IFuzz fuzzy, IEnumerable<T> elements, Count count = default) =>
